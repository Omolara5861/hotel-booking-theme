  ...
  return (
    <div className="bg-hero-image bg-cover bg-center h-[200px] rounded-3xl mb-20">
      <div className="bg-primaryColor bg-opacity-30 h-[200px] rounded-3xl">
        ...
        <form className=" flex gap-4 bg-white rounded-[20px] w-[88%] mx-auto min-h-[60px] p-4 -mt-6">
...
<PiMapPin />
            ...
            <input type="text"  className="outline-none w-[160px]" placeholder='Where are you going?' />
      <div className="ml-3">
...
<PiUser />
            ...
            <input type="text" className="outline-none w-[150px]" placeholder='3 Adults' />
